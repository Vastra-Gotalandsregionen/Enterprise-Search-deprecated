...
Utöver detta dokument finns också [en mall för aktivitetsplan](sokstrategi-aktivitetsplan.md) samt [ett appendix som försöker introducera sök](https://docs.google.com/a/webbfunktion.com/document/d/1un6q9G8bu2UMUybBjytjL8-ceUdK1yeetWHfceH7dO0/edit?usp=sharing) för noviser, enkät för [mätning av användningsnöjdhet](https://sv.surveymonkey.com/r/soknojdhetsindex) samt en [mall för förteckning av informationskällor](https://drive.google.com/file/d/0B4DggB8J5HwrY3Q2VG9ZZEVadUE/view?usp=sharing).
...
![Kvadrant för hur man kan se på en användare av sök](img/expert-novis.png)
Illustration inspirerad av boken [_Designing the Search Experience_](http://designingthesearchexperience.com/).
...
Fördjupning: [Enterprise Search Team Management](http://www.intranetfocus.com/wp-content/uploads/Enterprise-Search-Team-Management.pdf) av Martin White.
...
- Dess kanoniska adress, alltså vilken som är dess ursprungliga och huvudsakliga webbadress. Så kallad [Canonical URL](https://support.google.com/webmasters/answer/139066?hl=en).

Genom att använda [schema.org](https://schema.org/) specifikationen kan kraven på metadata, och delvis kravet på en gemensam begreppsvärld, tillgodoses.
